...
public class GerarRemessa implements AcaoRotinaJava {
        ...
        private void buscaNotasCanceladas(ContextoAcao ctx) throws Exception {
                QueryExecutor query = ctx.getQuery();
                query.setParam("DTINI", dtIni);
                query.setParam("DTFIN", dtFin);
                query.setParam("CODEMP", codEmp);
                ...
                query.nativeSelect("SELECT \r\n" + //
                                "    LANC.NUFIN,\r\n" + //
                                "    LANC.VLRDEB AS VLR,\r\n" + //
                                "    (SELECT CONTA FROM AD_LANCINTAUTBANK WHERE NUFIN = LANC.NUFIN AND VLRCRED=LANC.VLRDEB AND VLRCRED IS NOT NULL AND LANC <> 'C') AS CONTA1,\r\n" + //
                                "    (SELECT CONTA FROM AD_LANCINTAUTBANK WHERE NUFIN = LANC.NUFIN AND VLRDEB=LANC.VLRDEB AND VLRDEB IS NOT NULL AND LANC <> 'C') AS CONTA2,\r\n" + //
                                "    LANC.COMPLEMENTOS,\r\n" + //
                                "    LANC.CODCENCUS,\r\n" + //
                                "    CAN.DTCANC\r\n" + //
                                "FROM TGFCAN CAN\r\n" + //
                                "INNER JOIN AD_LANCINTAUTBANK LANC ON CAN.NUNOTA = LANC.NUFIN AND LANC.VLRCRED IS NULL\r\n" + //
                                "WHERE onlyDate(CAN.DTCANC) >= {DTINI}\r\n" + //
                                "AND onlyDate(CAN.DTCANC) <= {DTFIN}\r\n" + //
                                "AND CAN.CODEMP = {CODEMP}\r\n" + //
                                "AND CAN.NUNOTA IN (SELECT NUFIN FROM AD_LANCINTAUTBANK WHERE LANC <> 'C')\r\n" + //
                                "AND LANC.LANC <> 'C'\r\n" + //
                                "UNION ALL\r\n" + //
                                "SELECT\r\n" + //
                                "    LANC.NUFIN,\r\n" + //
                                ...
                                "    LANC.CODCENCUS,\r\n" + //
                                "    LANC.DTLANC\r\n" + //
                                "FROM AD_LANCINTAUTBANK LANC \r\n" + //
                                "WHERE LANC.VLRCRED IS NULL\r\n" + //
                                "AND LANC.NUFIN\r\n" + //
                                "IN (SELECT  \r\n" + //
                                "    (SELECT NUFIN FROM TGFFIN_EXC WHERE NUMNOTA=CAN.NUMNOTA)\r\n" + //
                                "FROM TGFCAN CAN\r\n" + //
                                "INNER JOIN AD_LANCINTAUTBANK LANC ON CAN.NUNOTA = LANC.NUFIN AND LANC.VLRCRED IS NULL\r\n" + //
                                "WHERE onlyDate(CAN.DTCANC) >= {DTINI}\r\n" + //
                                "AND onlyDate(CAN.DTCANC) <= {DTFIN}\r\n" + //
                ...
                while (query.next()) {
                        ...
                        fin.setVlrDesdob(query.getBigDecimal("VLR"));
                        fin.setComplemento(query.getString("COMPLEMENTOS"));
                        fin.setCtaCtb(query.getString("CONTA2"));
                        fin.setCtaCtbPtd(query.getString("CONTA1"));
                        fin.setCodCencus(query.getString("CODCENCUS"));
                        fin.setDt(query.getTimestamp("DTCANC"));
                        fin.setLancamento("C");
                        listFin.add(fin);
                        ...
                        if (!fin.getContrato()) {
                                if ("S".equals(fin.getLancamento()) || "E".equals(fin.getLancamento())) {
                                        ...
                                        lancDAO.create()
                                                        ...
                                                        .save();
                                        lanc++;
                                } else if ("C".equals(fin.getLancamento())) {
                                        lancDAO.create()
                                                        .set("ID", id)
                                                        .set("NUFIN", fin.getNuFin())
                                                        .set("NUMREM", numRem)
        ...
        private void buscaFinanceiroLiquidacao(ContextoAcao ctx) throws Exception {
                ...
                query.nativeSelect("SELECT FIN.NUFIN,\r\n" + //
                                ...
                                "    ) AS DESCRPROD,\r\n" + //
                                "    ((SELECT COUNT(1) FROM TGFRAT WHERE NUFIN = FIN.NUFIN AND ORIGEM='F')\r\n" + //
                                "    +\r\n" + //
                                "    (SELECT COUNT(1) FROM TGFRAT WHERE NUFIN IN (SELECT NUNOTA FROM TGFCAB WHERE NUMNOTA IN (SELECT NUMNOTA FROM TGFFIN WHERE NUFIN=FIN.NUFIN)) AND ORIGEM='E')\r\n" + //
                                "    ) AS QTD\r\n" + //
                                " FROM TGFFIN FIN\r\n" + //
                ...
                while (query.next()) {
                        if (query.getBigDecimal("QTD").compareTo(BigDecimal.ZERO) != 0
                                        && query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) != 0) {
                                ...
                                query2.nativeSelect("SELECT \r\n" + //
                                                ...
                                                "    RTRIM(PAR.NOMEPARC) AS NOMEPARC\r\n" + //
                                                "FROM TGFRAT RAT\r\n" + //
                                                "LEFT JOIN TGFCAB CAB ON CAB.NUNOTA = RAT.NUFIN\r\n" + //
                                                "LEFT JOIN TGFFIN FIN ON FIN.NUFIN = (SELECT MAX(NUFIN) FROM TGFFIN WHERE NUMNOTA=CAB.NUMNOTA)\r\n" + //
                                                "LEFT JOIN TGFNAT NAT ON NAT.CODNAT = RAT.CODNAT\r\n" + //
                                                "LEFT JOIN TSICUS CUS ON CUS.CODCENCUS = RAT.CODCENCUS\r\n" + //
                                                "LEFT JOIN TSICTA CTA ON CTA.CODCTABCOINT = FIN.CODCTABCOINT\r\n" + //
                                                "LEFT JOIN TGFMBC MBC ON MBC.NUBCO = FIN.NUBCO\r\n" + //
                                                "LEFT JOIN TGFPAR PAR ON PAR.CODPARC = FIN.CODPARC\r\n" + //
                                                "WHERE RAT.NUFIN IN (SELECT NUNOTA FROM TGFCAB WHERE NUMNOTA IN (SELECT NUMNOTA FROM TGFFIN WHERE NUFIN={NUFIN})) AND RAT.ORIGEM='E'");
                                while (query2.next()) {
                                        String complemento = query2.getString("OBSERVACAO");
                                        complemento = complemento != null
                                                        ? query2.getString("NUMNOTA") + " - "
                                                                        + query2.getString("NOMEPARC")
                                                                        + " - "
                                                                        + complemento
                                                        : query2.getString("NUMNOTA") + " - "
                                                                        + query2.getString("NOMEPARC");
                                        ...
                                        fin4.setComplemento(complemento);
                                ...
                                if (query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) == 0) {
                                        ...
                                        complemento = query.getString("DESCRPROD") != null
                                                        ? query.getString("NUMNOTA") + " - "
                                                                        + query.getString("NOMEPARC")
                                ...
                                fin.setLancamento(query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) == 0 ? "E"
                                                : "S");
                                listFin.add(fin);
                                ...
                                if (query.getBigDecimal("VLRJURO").compareTo(BigDecimal.ZERO) != 0
                                        ...
                                        fin2.setVlrDesdob(query.getBigDecimal("VLRJURO")
                                                        .add(query.getBigDecimal("VLRMULTA")));
                                        ...
                                        fin2.setLancamento(query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) == 0
                                                        ? "E"
                                                        : "S");
                                        listFin.add(fin2);
                                }
                                ...
                                if (query.getBigDecimal("VLRDESC").compareTo(BigDecimal.ZERO) != 0) {
                                        ...
                                        fin3.setCtaCtb(query.getString("AD_CODCTACT"));
                                        fin3.setCtaCtbPtd(query.getString("AD_CONTACONTADESC"));
                                        fin3.setRecDesp(query.getBigDecimal("RECDESP"));
                                        fin3.setDt(query.getTimestamp("DHCONCILIACAO"));
                                        fin3.setLancamento(query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) == 0
                                                        ? "E"
                                                        : "S");
                                        listFin.add(fin3);
                                }
        ...
        private void buscaFinanceiroProvisao(ContextoAcao ctx) throws Exception {
                ...
                query.nativeSelect("WITH AggregatedProd AS (\r\n" + //
                                ...
                                "QtdTGFRAT AS (\r\n" + //
                                "    -- CTE 2: QtdTGFRAT\r\n" + //
                                "    SELECT FIN.NUFIN, COUNT(1) AS QTD\r\n" + //
                                "    FROM TGFRAT R\r\n" + //
                                "    INNER JOIN TGFFIN FIN ON R.NUFIN = FIN.NUFIN\r\n" + //
                                "    WHERE R.ORIGEM = 'F'\r\n" + //
                                "    GROUP BY FIN.NUFIN\r\n" + //
                                ")\r\n" + //
                                "\r\n" + //
                                ...
                                "       FIN.NUMNOTA,\r\n" + //
                                "       RTRIM(PAR.NOMEPARC) AS NOMEPARC,\r\n" + //
                                "       CASE WHEN FIN.RECDESP = 0 THEN\r\n" + //
                                "        CASE WHEN CAB.TIPMOV='V' THEN 1 ELSE -1 END\r\n" + //
                                "        ELSE FIN.RECDESP END AS RECDESP,\r\n" + //
                ...
                while (query.next()) {
                        if (query.getBigDecimal("QTD").compareTo(BigDecimal.ZERO) != 0
                                ...
                                while (query3.next()) {
                                        String complemento = query3.getString("OBSERVACAO");
                                        complemento = complemento != null
                                                        ? query3.getString("NUMNOTA") + " - "
                                                                        + query3.getString("NOMEPARC")
                                                                        + " - "
                                                                        + complemento
                                                        : query3.getString("NUMNOTA") + " - "
                                                                        + query3.getString("NOMEPARC");
                                        complemento = query3.getString("AD_CODCENCUSATBK") != null
                                                        ? query3.getString("AD_CODCENCUSATBK") + " - " + complemento
                                                        : complemento;
                                        Financeiro fin4 = new Financeiro();
                                ...
                                fin.setLancamento(query.getBigDecimal("RECDESP").compareTo(BigDecimal.ONE) == 0 ? "PE"
                                                : "PS");
                                listFin.add(fin);
                        }
        ...
        private void buscaFinanceiroProvisaoContratos(ContextoAcao ctx) throws Exception {
                ...
                query.nativeSelect("WITH AggregatedProd AS (\n" + //
                                ...
                                "       CAB.NUMCONTRATO,\n" + //
                                "       AGG.DESCRPROD,\n" + //
                                "       nullValue(QTD.QTD,0) AS QTD  -- Adicionando o campo QTD do subselect\n" + //
                                "FROM TGFCAB CAB\n" + //
                                "INNER JOIN TGFFIN FIN ON FIN.NUFIN = (SELECT MAX(NUFIN) FROM TGFFIN WHERE NUNOTA = CAB.NUNOTA)\n"
                                + //
                                "INNER JOIN TGFITE ITE ON ITE.NUNOTA = CAB.NUNOTA\n" + //
                                ...
                                "LEFT JOIN AggregatedProd AGG ON CAB.NUNOTA = AGG.NUNOTA\n" + //
                                "LEFT JOIN (\n" + //
                                "    SELECT NUFIN, COUNT(*) AS QTD\n" + //
                                "    FROM TGFRAT\n" + //
                                "    WHERE ORIGEM = 'F'\n" + //
                                "    GROUP BY NUFIN\n" + //
                                ") QTD ON QTD.NUFIN = FIN.NUFIN  -- Subselect para calcular a quantidade\n" + //
                                "WHERE onlyDate(CAB.DTNEG) >= {DTINI}\n" + //
                                "   AND onlyDate(CAB.DTNEG) <= {DTFIN}\n" + //
                                "   AND CAB.CODEMP = {CODEMP}\n" + //
                                "   AND NAT.AD_CONTABILIZAVEL = 'S'\n" + //
                                ...
                                "          CAB.NUMCONTRATO,\n" + //
                                "          AGG.DESCRPROD,\n" + //
                                "          QTD.QTD  -- Adicionando o campo QTD à cláusula GROUP BY");
        ...
        private void buscaDiferimentoContratos(ContextoAcao ctx) throws Exception {
                ...
                query.nativeSelect("SELECT\r\n" + //
                                "CON.NUMCONTRATO,\r\n" + //
                                "FORMAT([SANKHYA].[Get_proximo_dia_util](CAB.DTNEG,0,0,3), 'dd/MM/yy') AS DTCONTRATO,\r\n" + //
                                "CON.TIPO,\r\n" + //
                                ...
                                "LEFT JOIN TSICUS CUS\r\n" + //
                                "    ON CUS.CODCENCUS = FIN.CODCENCUS\r\n" + //
                                "WHERE CON.TIPO NOT IN ('M', 'L') \r\n" + //
                                "    AND CON.CODEMP = {CODEMP}\r\n" + //
                                "    AND CAB.DTNEG BETWEEN {DTINI} AND {DTFIN}\r\n" + //
                                "UNION ALL\r\n" + //
                                "SELECT\r\n" + //
                                "CON.NUMCONTRATO,\r\n" + //
                                "FORMAT([SANKHYA].[Get_proximo_dia_util](DATEADD(DAY, -DAY({DTINI}) + 1, {DTINI}),0,0,3), 'dd/MM/yy') AS DTCONTRATO,\r\n" + //
                                "CON.TIPO,\r\n" + //
                                "(SELECT SUM(VLRTOT) FROM TGFITE WHERE NUNOTA=CAB.NUNOTA) AS VLRTOT,\r\n" + //
                                "FIN.NUMNOTA,\r\n" + //
                                "FIN.NUFIN,\r\n" + //
