...
SELECT CAD.SEQESCAL,ORD.ORDEMCARGA, CAD.VLRFRETETAB,ORD.AD_CODTIPVEI, ORD.CODVEI1, VEI.AD_CODTIPVEI AS CODTIPVEI FROM AD_CADESCALA cad 
inner join TGFORD ORD ON ORD.ORDEMCARGA = CAD.ORDEMCARGA 
INNER JOIN TGFVEI VEI ON VEI.CODVEICULO = ORD.CODVEI1
WHERE cad.TIPODECARGA = 'B'
AND ORD.AD_CODTIPVEI <> VEI.AD_CODTIPVEI;
