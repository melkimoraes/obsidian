...
-> NUNOTAENTREMSIMB 
-> NUNOTAREMBOBINA (VER SE APROVOU NA IMGJ!) 
		fatura NA DASH!
-> NUNOTARETBOBINA → XML DA ARTIVINCO NA IMGJ! (TRG_AI_TGFNFE_TGFIXNIMGJ_ART)
-> NUNOTARETBOBINAIMGJ 
-> NUNOTAPRODUCAO 
→ NUNOTAPEDIMGJ → NAO ESTA CONFIRMANDO AUTOMATICAMENTE! (ESSA AQUI TEM QUE PXUAR O NUMNOTA DO PREFAT!)
